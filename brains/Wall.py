	...
	def determineMove(self, front, left, right):
		...
		if self.state == 'initial':
			...
			if front < 0.5:
				...
				translation = 0
				rotation = 0.8
			elif meanMeasurements[rightiest] > 0.2 and meanMeasurements[rightiest] < 0.25 and meanMeasurements[leftiest] > 0.27 and meanMeasurements[leftiest] < 0.32:
				translation = 1
			elif meanMeasurements[rightiest] > 0.25 or meanMeasurements[leftiest] > 0.32:
				translation = 0.2
				rotation = -0.4
			elif meanMeasurements[rightiest] < 0.2 or meanMeasurements[leftiest] < 0.27:
				translation = 0.2
				rotation = 0.4
			else:
				translation = 0.8
