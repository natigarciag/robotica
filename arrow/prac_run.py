...
shrinkFactor = 4
segImg = np.empty((config.imageShape['height']/shrinkFactor, config.imageShape['width']/shrinkFactor), dtype='uint8')
...
while (capture.isOpened()):
    ...
    cv2.imshow("Segmentacion Euclid",cv2.cvtColor(paleta[segImg], cv2.COLOR_RGB2BGR))
