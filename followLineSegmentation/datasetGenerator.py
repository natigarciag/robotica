...
# hsImages = np.memmap('./datasets/hsImagesLine.driver', dtype='uint8', mode='r', shape=(config.numberOfImages, config.imageShape['height'], config.imageShape['width'], 2))
# markedImages = np.memmap('./datasets/markedImagesLine.driver', dtype='uint8', mode='r', shape=(config.numberOfImages, config.imageShape['height'], config.imageShape['width'], 3))
...
# print shapeD
# dataset = np.memmap('./datasets/datasetLine.driver', dtype=np.uint8, mode='w+', shape=shapeD)
...
shapeD = (61983, 3)
dataset = np.memmap('./datasets/datasetLine.driver', dtype=np.uint8, mode='r', shape=shapeD)
