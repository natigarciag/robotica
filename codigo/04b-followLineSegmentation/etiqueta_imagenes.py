...
hsImages = np.memmap('./datasets/hsImagesLine.driver', dtype='uint8', mode='w+', shape=(config.numberOfImages, config.imageShape['height'], config.imageShape['width'], 2))
markedImages = np.memmap('./datasets/markedImagesLine.driver', dtype='uint8', mode='w+', shape=(config.numberOfImages, config.imageShape['height'], config.imageShape['width'], 3))
